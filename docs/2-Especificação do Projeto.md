...
|**Sandro Pipoca**|           |                             | 
|-------------------|-----------|-----------------------------|
<img src="https://github.com/ICEI-PUC-Minas-PPC-CC/Template-MentoringII/blob/main/docs/img/camilafiaes.png" width="200" height="200"/>|**Idade:** 69 anos. **Naturalidade:** Poços de Caldas - Minas Gerais. **Ocupação:** Aposentado.  |**Atribuições:** Compras Online. 
